...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    public MyAdapter(List<Recipe> myDataset, OnItemClickListener listener) {
        values = myDataset;
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.txtHeader.setText(currentRecipe.name);
        holder.txtFooter.setText(currentRecipe.description);
